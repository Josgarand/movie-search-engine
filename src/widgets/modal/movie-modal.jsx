...
export function MovieModal({ open, onClose, movie }) {
  ...
  return (
    <Dialog open={open} handler={onClose} size="lg" className="p-4">
      ...
      <DialogBody divider className="flex flex-col lg:flex-row gap-6">
        <img
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600">{overview || "No hay descripción disponible."}</p>
        </div>
      </DialogBody>

      <DialogFooter>
        <Button color="red" onClick={onClose} className="px-6">
          Cerrar
        </Button>
      </DialogFooter>
    </Dialog>
